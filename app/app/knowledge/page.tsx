...
export default function Knowledge() {
  return (
    <div className="flex flex-col lg:flex-row gap-space-8 overflow-y-auto">
      <div className="flex-1">
        <p className="text-fontSize-7 font-semibold mb-space-3">
          Confluence knowledge base
        </p>
        <div className="p-6 border border-border-input">
          <ul
            className="pl-space-3"
      ...
      <div className="flex-1">
        <div>
          ...
          <Button className="text-black block mb-space-3 bg-scale-neutral-200">
            Join Slack channel #appfire-ignite
          </Button>
          <Button className="text-black mb-space-3 bg-scale-neutral-200">
            Add Ignite event to calendar
          </Button>
        </div>
        <Separator className="my-3" />
        <div className="mt-space-3">
          <p className="text-fontSize-7 font-semibold mb-space-4">Timeline</p>
        ...
        <div className="mt-space-6">
          <p className="text-fontSize-7 font-semibold mb-space-6">Recordings</p>
          <div style={{ color: "var(--link)" }}>
            <a className="link block mb-space-4" href="">
              Kick of
            </a>
            <a className="link block mb-space-4" href="">
